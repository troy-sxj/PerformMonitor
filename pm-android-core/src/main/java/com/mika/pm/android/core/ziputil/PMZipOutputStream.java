...
/**
 * @Author: mika
 * @Time: 2019-11-05 18:06
 * @Description:
 */
public class PMZipOutputStream extends FilterOutputStream implements ZipConstants {
    /**
    ...
    private PMZipEntry currentEntry;
     ...
     */
    public PMZipOutputStream(OutputStream os) {
        this(os, false /* forceZip64 */);
    }
    /**
     * @hide for testing only.
     */
    public PMZipOutputStream(OutputStream os, boolean forceZip64) {
        super(os);
     ...
     * explicitly specify a method. See {@link PMZipEntry#setMethod} for more details.
     */
    ...
    public void closeEntry() throws IOException {
        ...
        int flags = currentEntry.getMethod() == STORED ? 0 : PMZipFile.GPBF_DATA_DESCRIPTOR_FLAG;
        ...
        flags |= PMZipFile.GPBF_UTF8_FLAG;
     ...
     * @see #write
     */
    public void putNextEntry(PMZipEntry ze) throws IOException {
        if (currentEntry != null) {
            closeEntry();
        }
        ...
        // Local file header.
        // http://www.pkware.com/documents/casestudies/APPNOTE.TXT
        int flags = (method == STORED) ? 0 : PMZipFile.GPBF_DATA_DESCRIPTOR_FLAG;
...
//        }
    ...
    /**
     * Sets the comment associated with the file being written. See {@link PMZipFile#getComment}.
